        ...
        <Home>
            <div className="flex flex-col justify-center items-center">
                ...
                <header className="mt-8 pt-16 px-12 after:content after:w-full after:h-64 absolute bottom-0 header">
                    <div className="m-auto flex flex-col items-center gap-10 py-0 px-10 header__content">
                        ...
                        <Link href="#subscription" className="outline-3 outline-transparent hover:bg-transparent hover:bg-cover hover:outline-2 hover:outline-secondary hover:scale-125  button button-gradient header__button"> Assine Agora </Link>
                        <p className="font-quicksand text-base font-light max-w-80 text-center text-small"> *aplicável ao plano anual com o<br/>pagamento antecipado. </p>
                    </div>
                </header>
                    ...
                    <section id="content" className="bg-cover content max-w-7xl w-full m-auto p-6 text-center container">
                        ...
                        <div className="content__container">
                            <div className="content__card">
                                <img src="https://raw.githubusercontent.com/naejshaw/hbomax/master/assets/images/hbo-default_0.webp" alt="" className="content__img"/>
                            </div>
                            <div className="content__card">
                                <img src="https://raw.githubusercontent.com/naejshaw/hbomax/master/assets/images/MAX-Default.webp" alt="" className="content__img"/>
                            </div>
                            <div className="content__card">
                                <img src="https://raw.githubusercontent.com/naejshaw/hbomax/master/assets/images/DC_Default.webp" alt="" className="content__img"/>
                            </div>
                            <div className="content__card">
                                <img src="https://raw.githubusercontent.com/naejshaw/hbomax/master/assets/images/WB-Default.webp" alt="" className="content__img"/>
                            </div>
                            <div className="content__card">
                                <img src="https://raw.githubusercontent.com/naejshaw/hbomax/master/assets/images/CN-Default.webp" alt="" className="content__img"/>
                            </div>
                            <div className="content__card">
                                <img src="https://raw.githubusercontent.com/naejshaw/hbomax/master/assets/images/UCL-Default.webp" alt="" className="content__img"/>
                            </div>
                        </div>
                    </section>
                </main>
