    ...
    return(<>
        <div className="relative rounded-3xl overflow-hidden flex portfolio-box" id={id}>
            ...
            <div className="absolute bottom-0 left-0 w-full h-full flex justify-evenly items-center flex-col text-center py-0 px-16 translate-y-48 duration-500 hover:translate-y-0 bg-[#00eeff1f] portfolio-layer">
                ...
                <Link className="inline-flex justify-center items-center w-8 h-8 md:w-10 md:h-10 lg:w-12 lg:h-12 bg-[#fff] rounded-full" to={data.path}><i className="text-[#081b29] fa fa-arrow-right"></i></Link>
            </div>
        </div>
    </>)
}
