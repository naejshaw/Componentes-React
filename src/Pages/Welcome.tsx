  ...
  return (
    <>
      <Site>
        <Section
          className={
            "min-h-screen mt-20 md:mt-12 flex items-center bg-cover bg-center bg-site-bg"
          }
          id={"home"}
        >
          <div className="absolute flex flex-col items-center justify-center">
            <div className="max-w-5xl z-40 home-content flex flex-col">
              ...
              <p className="relative text-lg md:text-xl lg:text-2xl my-8 mr-16">
                ...
                Tempora perferendis commodi illum atque a soluta libero et quas
                placeat, molestiae possimus sunt ut. Sint, sapiente velit! Ullam
                sapiente veniam minus!
              </p>
              <div className="relative flex gap-4 md:justify-between w-[22rem] h-[5rem] hover:text-primary">
                <Button
                  className={
                    "relative inline-flex justify-center items-center w-[8rem] md:w-[9rem] lg:w-[10rem] max-h-12 rounded-lg bg-primary border-[.2rem] border-solid border-primary text-base md:text-lg lg:text-xl font-semibold text-site-bg z-10 overflow-hidden duration-500 hover:text-primary hover:bg-primary before:absolute before:top-0 before:left-0 before:w-0 before:h-full before:bg-site-bg before:-z-10 before:duration-500 hover:before:w-full btn"
                  }
                  link={"#"}
                  title={"Hire Me"}
                />
              ...
              <div className="w-52 ml-0 flex justify-between home-sci">
                <Button
                  className={
                    "relative inline-flex justify-center items-center w-10 h-10 bg-transparent border-spacing-1 border-primary rounded-lg text-xl text-primary z-10 overflow-hidden duration-500 "
                  }
                  link={media.facebook}
                  social={"facebook"}
                />
          ...
          <img
            className="min-h-screen min-w-screen scale-x-150 md:scale-x-125 lg:scale-x-100 mr-0 relative"
            src={imgPathHome}
            alt=""
          />
        ...
        >
          ...
          <div className="text-center about-content">
            ...
            <p className="relative text-lg md:text-xl lg:text-2xl m-9">
              ...
              veritatis distinctio, modi iste nostrum labore autem. Soluta
              repellendus accusamus, doloremque ratione nam tempora hic
              pariatur, ad quae expedita, sapiente nisi!
              <span className="bg-primary animate scroll" />
            </p>
            <div className="inline-block w-60 btn-box btns">
              <Button
                className={
                  "relative justify-center items-center bg-primary text-xl font-normal text-site-bg z-10 overflow-hidden duration-500 hover:text-primary hover:bg-primary before:absolute before:top-0 before:left-0 before:w-0 before:h-full before:bg-site-bg before:-z-10 before:duration-500 before:hover:w-full cursor-pointer btn inline-block w-60 mt-4 py-2 border-primary border-solid border-2 rounded-md"
                }
                link={"#"}
                title={"Read More"}
              />
        ...
        >
          <div className="flex flex-wrap gap-20 education-row">
            <Subject
              containerClass={
                "relative border-l-[.2rem] border-solid border-primary education-box"
              }
              title={"Education"}
            >
              <Card
                cardDate={education.period}
                cardText={
                  "Lorem ipsum dolor sit, amet consectetur adipisicing elit. Placeat reprehenderit quidem quia eos dolor possimus cumque. Molestias tenetur odit dolorum."
                }
                cardTitle={education.degree + " - " + education.name}
              />
              <Card
                cardDate={education2.period}
                cardText={
                  "Lorem ipsum dolor sit, amet consectetur adipisicing elit. Placeat reprehenderit quidem quia eos dolor possimus cumque. Molestias tenetur odit dolorum."
                }
                cardTitle={education2.degree + " - " + education2.name}
              />
              <Card
                cardDate={education3.period}
                cardText={
                  "Lorem ipsum dolor sit, amet consectetur adipisicing elit. Placeat reprehenderit quidem quia eos dolor possimus cumque. Molestias tenetur odit dolorum."
                }
                cardTitle={education3.degree + " - " + education3.name}
              />
            </Subject>
            <Subject
              containerClass={
            ...
            >
              <Card
                ...
                cardTitle={job.name + " - " + job.company}
              />
              <Card
                cardDate={job2.period}
                cardText={
                  "Lorem ipsum dolor sit, amet consectetur adipisicing elit. Placeat reprehenderit quidem quia eos dolor possimus cumque. Molestias tenetur odit dolorum."
                }
                cardTitle={job2.name + " - " + job2.company}
              />
              <Card
                cardDate={job3.period}
                cardText={
                  "Lorem ipsum dolor sit, amet consectetur adipisicing elit. Placeat reprehenderit quidem quia eos dolor possimus cumque. Molestias tenetur odit dolorum."
                }
                cardTitle={job3.name + " - " + job3.company}
              />
            </Subject>
          </div>
        </Section>
        ...
        <Section
          className={"min-h-screen pt-40 px-[9%] min-h-auto pb-28 contact"}
          id={"contact"}
          title={"Contact"}
          titleSpan={"Me!"}
        >
          <form className="max-w-[70rem] my-0 mx-auto text-center" action="#">
            ...
            <div className="btn-box btns">
              <Button
                className={
                  "relative justify-center items-center bg-primary text-base md:text-lg lg:text-xl font-normal text-site-bg z-10 overflow-hidden duration-500 hover:text-primary hover:bg-primary before:absolute before:top-0 before:right-0 before:w-0 before:h-full before:bg-site-bg before:-z-10 before:duration-500 before:hover:w-full cursor-pointer btn inline-block w-60 mt-4 py-2 border-primary border-solid border-2 rounded-md"
                }
                title={"Submit"}
                type={"submit"}
              />
